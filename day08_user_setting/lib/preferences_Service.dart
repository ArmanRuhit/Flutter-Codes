...
class PreferenceService{
  Future saveSettings(Settings settings) async{
    ...
    await preferences.setStringList('programmingLanguages', settings.programmingLanguages.map((lang) => lang.index.toString()).toList());
  ...
  Future<Settings> getSetting() async{
    ...
    final programingLanguages = programmingLanguagesIndices.map((stringIndex) => ProgrammingLanguage.values[int.parse(stringIndex)]).toSet();

    return Settings(
      username: username,
      gender: gender,
      programmingLanguages: programingLanguages,
